...
Stopwatch.prototype.reset = function() {
    ...
    document.getElementById('watchdisplay').innerHTML = '00:00:000';
}
...
Stopwatch.prototype.toString = function() {
    ...
    return zpad(e.minutes,2) + ":" + zpad(e.seconds,2) + ":" + zpad(e.milliseconds,3);   //  REMOVED zpad(e.hours,2) + ":" + 
}

Stopwatch.prototype.toMili = function() {
    var e = this.getElapsed();
    return e.minutes * 60 * 1000 + e.seconds * 1000 + e.milliseconds;   //  REMOVED zpad(e.hours,2) + ":" + 
